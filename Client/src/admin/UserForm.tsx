import { Button, Checkbox, FormControlLabel, IconButton, TextField, Typography } from "@suid/material";
...
export function UserForm(props:{
    ...
    const [form, setForm] = createStore<UserInfo>(props.toEdit || {
        id: -1,
        name: "",
        email: "",
    });
    ...
    const PasswordContainer = () => {
        return (
            <div style={{ display: "flex", "justify-content": "space-between" }}>
                ...
                <IconButton sx={{ width: "40px", height: "40px" }} onClick={() => { setPassword(generateRandomPassword()); }}>
                    <RestartAlt />
                </IconButton>
            </div>
        )
    ...
    return (
        <div id="map_form_container">
            <div id="field_form">
                ...
                <Show when={props.toEdit !== undefined} 
                    fallback={<PasswordContainer />}>
                    <FormControlLabel
                        control={<Checkbox checked={newPassword()} onChange={() => {
